...
import model.*;
import service.CampaignImageServiceImpl;
...
public class UpdateController extends HttpServlet {
    ...
    private IVoucherByPriceService voucherByPriceService = new VoucherByPriceServiceImpl();
    private IVoucherByProductService voucherByProductService = new VoucherByProductServiceImpl();
