<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Ergo</span>
        </a>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Lặp qua tất cả các menu item
        menuItems.forEach(function (item) {
            // Lấy đường dẫn href của mục menu
            const link = item.querySelector('a');
            if (link) {
                const linkHref = link.getAttribute('href');
                // So sánh đường dẫn của menu item với URL hiện tại
                if (currentUrl === linkHref || currentUrl === linkHref.replace('.html', '') || currentUrl === '/' + linkHref) {
                    // Thêm class active cho mục này nếu URL khớp
